...
class arqQ():
    ...
    def initial_push(self,consolidated_station_data,rootWorkspace,typeId):
        ...
        pushed_components = []
        for components in consolidated_station_data:
            pushed_components.append(self.ARD_request(method="POST", endpoint='/api/v2/components',ARDOQ_API_HOST='XXX',ARDOQ_API_TOKEN='xxx', data=components))
    ...
    def delete_all_components(self,existing_data):
        ...
        for component in existing_data['values']:
            ...
            delete_responses.append(self.ARD_request(method="DELETE", endpoint='/api/v2/components', path_param=id,ARDOQ_API_HOST='XXX',ARDOQ_API_TOKEN='xxx'))
